...
public class Contac2Activity extends AppCompatActivity {
    ...
    public void showContacts() {
        ...
        try {
            ...
            do {
                ...
                // Toast.makeText(this, id + "-" + nombre + " " + apellidos, Toast.LENGTH_SHORT).show();

                //lista
                list_one.add(id + "-" + nombre + " " + apellidos);
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, list_one);
